...
const data: Payment[] = Array(100)
  .fill(0)
  .map((_, index) => ({
    id: `payment-${index}`,
    event_name: "Filled Name",
    event_start: "Jan 12, 2024",
    event_end: "Jan 14, 2024",
    client_name: "Mohammad Asad",
    contact_info: "+1234 567 890",
    venue: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
  }));

const positionData: Position[] = Array(10)
  .fill(0)
  .map((_, index) => ({
    id: `position-${index}`,
...
const positionColumns: ColumnDef<Position>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="lowercase">{row.getValue("info")}</div>,
  },
  {
...
export const columns: ColumnDef<Payment>[] = [
  {
    ...
    cell: ({ row }) => (
      <div className="lowercase">{row.index + 1}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="lowercase">{row.getValue("event_name")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => <div className="">{row.getValue("event_start")}</div>,
  },
  {
    ...
    cell: ({ row }) => <div className="">{row.getValue("event_end")}</div>,
  },
  {
  ...
  return (
    <div className="w-full">
      <div className="flex justify-between items-center py-4">
        <span className="font-semibold text-2xl">Event Requests</span>
  ...
  return (
    <div className="w-full">
      <div className="flex justify-start items-center">
        <span className="text-xl mb-2">Positions</span>
      </div>
